...
class ZezeProductionAgent(BaseDepartmentAgent):
    ...
    async def execute_task(self, task_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        routes = [(["üretim", "prodüksiyon", "plan", "içerik üret", "kalite", "tedarik", "video", "asset"], self._handle_primary)]
        return await self.dispatch_by_task_type(task_data, routes, 'Sen ZezeLabs Üretim ajanısın. Ölçülebilir üretim planları üretirsin.')
