...
from PySide6.QtWidgets import (
    ...
    QScrollArea, QSplitter, QProgressBar, QMessageBox, QSystemTrayIcon, QMenu
)
...
class JarvisPySideMainWindow(QMainWindow):
    ...
    def setup_system_tray(self):
        ...
        icon_path = os.path.join(base_dir, "brain.ico")
        ...
        show_action = tray_menu.addAction("⚡ Arayüzü Göster")
        show_action.triggered.connect(self.showNormal)
        
        hide_action = tray_menu.addAction("📥 Arka Plana At")
        hide_action.triggered.connect(self.hide)
        
        tray_menu.addSeparator()
        
        exit_action = tray_menu.addAction("❌ Tamamen Kapat")
